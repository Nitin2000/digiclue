				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="myNavbar">
						...
						<ul class="nav navbar-nav navbar-right">
							<button type="button" class="btn btn-info btn-lg login1" ><li> <a href="login.php">Login</a></li></button> 
							<button type="button" class="btn btn-info btn-lg login1" ><li> <a href="register.php">register</a></li></button> 
						</ul>
			...
			<div class="row" id="contact_us">
				<div class="col-md-12 contactpart">
					...
					<div class="col-md-7 footaddress">
						...
						esh%20201309!5e0!3m2!1sen!2sin!4v1621087433072!5m2!1sen!2sin" width="100%" height="350"
